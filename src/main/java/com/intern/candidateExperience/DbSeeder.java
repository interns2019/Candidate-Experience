...
public class DbSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        String input6 = "2018-12-31" ;
        String input7 = "2017-12-31" ;
        ...
        Candidate c1 = new Candidate(qList1,ld1.plusDays(1),"Kaafi Acha Feedback");
        Candidate c2 = new Candidate(qList2,ld6.plusDays(1),"Aur ek Acha Feedback");
        Candidate c3 = new Candidate(qList1,ld2.plusDays(1),"Ek Feedback");
        Candidate c4 = new Candidate(qList1,ld3.plusDays(1),"2 Feedback");
        Candidate c5 = new Candidate(qList1,ld4.plusDays(1),"3 Feedback");
        Candidate c6 = new Candidate(qList3,ld5.plusDays(1),"4 Feedback");
        Candidate c7 = new Candidate(qList3,ld7.plusDays(1),"4 Feedback");
        Candidate c8 = new Candidate(qList2,ld8.plusDays(1),"4 Feedback");
        Candidate c9 = new Candidate(qList5,ld9.plusDays(1),"4 Feedback");
        Candidate c10 = new Candidate(qlist4,ld10.plusDays(1),"4 Feedback");
